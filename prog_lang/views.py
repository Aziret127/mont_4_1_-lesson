...
class SeachView(generic.ListView):
    ...
    def get_queryset(self):
        return self.model.objects.filter(title_icontains=self.request.GET.get('s'))
...
#     prog_lang_id = get_object_or_404(models.ProgLand, id=id)
...
# def create_porg_lang_view(request):
#     if request.method == 'POST':
...
# def proglang_detail_view(request, id):
...
#             request['viewed_lang'], views_lang

#         return render(
#             request,
#             "prog_language_detail.html",
#             {
#                 "prog_id": prog_lang_id
#             }
#         )

#list view - отображение списка всех языков программирования
